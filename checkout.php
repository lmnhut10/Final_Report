<?php
// Kiểm tra xem có sự kiện nhấn vào nút "Checkout" không
if(isset($_POST['checkout_button'])) {
    // Hiển thị thông báo thành công
    $success_message = "Checkout successful";
...
<head>
    ...
    <form method="post" action=""  >
        <!-- Nút "Checkout" -->
        <input type="submit" class="site-btn" name="checkout_button" value="Checkout">
    </form>
</body>
            </div>
        </div>
